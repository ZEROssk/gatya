...
typedef enum {
	eRANK_SUPAR_RARE_BEGIN = 0,
	eRANK_SUPAR_RARE_NAME0 = eRANK_SUPAR_RARE_BEGIN,
	eRANK_SUPAR_RARE_NAME1,
	eRANK_SUPAR_RARE_NAME2,
	eRANK_SUPAR_RARE_NAME3,
	eRANK_SUPAR_RARE_END,

	eRANK_SUPAR_RARE_MAX = eRANK_SUPAR_RARE_END,
} E_RANK_SUPAR_RARE;


const char* strRankSuparRareNames [eRANK_SUPAR_RARE_MAX] = {
	"アルトリア・ペンドラゴン",
	"モードレッド",
	"アルテラ",
};
...
typedef enum {
	eRANC_RARE_BEGIN = 0,
	eRANC_RARE_SUPER_RARE = eRANC_RARE_BEGIN,
	eRANC_RARE_RARE,
	eRANC_RARE_END

	eRANC_RARE_MAX = eRANC_RARE_END,
} E_RANC_TYPE;

void getSuperRareCard ()
{
	printf("┏━━━━━━━━┓\n");
	printf("┃ 星５鯖 ┃ ");
	//25
	...
	printf( " %s\n", strRankSuparRareNames[nameselectgo]);
				
	/* switch (nameselectgo) { */
	/* case eRANK_SUPAR_RARE_NAME0: */
	/*     printf(" アルトリア・ペンドラゴン\n"); */
	/* 	break; */
	/* case eRANK_SUPAR_RARE_NAME1: */
	/*     printf(" モードレッド\n"); */
	/* 	break; */
	/* case eRANK_SUPAR_RARE_NAME2: */
	/*     printf(" アルテラ\n"); */
	/* 	break; */
	/* case 3: */
	/*     printf(" オリオン\n"); */
